...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, KC_7,    KC_8,    KC_9, _______,                   KC_VOLD, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU, KC_MUTE,\
  ...
  _______, _______, KC_1,    KC_2,    KC_3, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
                             _______, _______, _______, _______, MO(_RAISE),  _______, _______, _______\
),
 ...
 */
 [_RAISE] = LAYOUT( \
  ...
  _______, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_EQL,                      _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, \
  _______, KC_LABK, KC_RABK, KC_LBRC, KC_RBRC, KC_BSLS,  _______, _______,  _______, KC_BTN1, KC_BTN2, KC_WH_D, KC_WH_U, _______, \
