...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_7,    KC_8,    KC_9, _______, _______,                   KC_VOLD, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU, KC_MUTE,\
  KC_0,    KC_4,    KC_5,    KC_6, _______, _______,                   KC_LEFT,  KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
